    ...
    <>
      ...
      <div className="container mx-auto px-10 mb-20 text-sm">
        <div>
          ...
          les "CGU") s'appliquent à votre utilisation de notre landing page
          (ci-après dénommée le "Site") qui permet de recueillir vos
          informations personnelles, telles que votre nom, prénom et adresse
          email (ci-après dénommées les "Informations Personnelles"). En
          utilisant notre Site, vous acceptez les présentes CGU et notre
          ...
          volontairement via notre Site. Nous utilisons ces informations pour
          vous fournir les services demandés, pour communiquer avec vous, pour
          personnaliser votre expérience sur notre Site et pour améliorer nos
          services. Nous pouvons également utiliser ces informations pour vous
          envoyer des newsletters, des offres spéciales ou toute autre
          information que nous jugeons pertinente pour vous.
          <br />
          <br />
          <br />
          <p className="font-bold text-lg">Propriété intellectuelle</p>
          <br />
          Le Site et tout son contenu, y compris les textes, les images, les
          marques et les logos, sont protégés par les lois sur la propriété
          intellectuelle en vigueur en France et dans le monde entier. Vous ne
          pouvez pas copier, reproduire, publier, télécharger, afficher,
          transmettre ou distribuer tout ou partie du contenu du Site sans notre
          autorisation écrite préalable.
          <br />
          <br />
          <br />
          <p className="font-bold text-lg">Responsabilité</p>
          <br />
          Nous ne serons pas responsables de tout dommage résultant de votre
          utilisation de notre Site, y compris mais sans s'y limiter, les
          dommages directs, indirects, accessoires, spéciaux ou consécutifs.
          Nous ne serons pas non plus responsables des pertes ou des dommages
          causés par un virus, une attaque par déni de service, ou tout autre
          matériel technologiquement nuisible qui pourrait infecter votre
          équipement informatique, vos programmes informatiques, vos données ou
          autre matériel exclusif en raison de votre utilisation de notre Site.
          <br />
          <br />
          <p className="font-bold text-lg">Modifications des CGU</p>
          <br />
          Nous nous réservons le droit de modifier les présentes CGU à tout
          moment et sans préavis. Les modifications entreront en vigueur dès
          leur publication sur le Site. Nous vous encourageons à consulter
          régulièrement les CGU pour vous tenir informé des changements
          éventuels.
          <br />
          <br />
          <p className="font-bold text-lg">
          ...
          découlant de ou lié à ces CGU sera soumis à la compétence exclusive
          ...
          présentes CGU ou notre Politique de Confidentialité, veuillez nous
          contacter à l'adresse email indiquée sur notre Site.
        </div>
      </div>
      <Footer />
    </>
