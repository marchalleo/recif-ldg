  ...
  return (
    <>
      ...
      <div className="container mx-auto px-10 mb-20 text-sm">
        <div>
          Les présentes Conditions Générales de Vente (ci-après dénommées les
          "CGV") s'appliquent à la vente de produits (ci-après dénommés les
          "Produits") proposés sur notre landing page (ci-après dénommée le
          "Site"). Les CGV régissent la vente de Produits entre l'acheteur
          (ci-après dénommé le "Client") et le vendeur (ci-après dénommé "Nous"
          ou "Vendeur"). En passant une commande sur notre Site, le Client
          accepte les présentes CGV.
          <br />
          <br />
          <br />
          <p className="font-bold text-lg">Commandes</p>
          <br />
          Le Client peut passer une commande sur notre Site en remplissant le
          formulaire de commande disponible sur le Site. Le Client doit fournir
          des informations exactes et complètes concernant sa commande, y
          compris le produit commandé. Le Client est responsable de l'exactitude
          des informations fournies. La validation de la commande par le Client
          vaut acceptation des présentes CGV.
          <br />
          <br />
          <br />
          <p className="font-bold text-lg">Prix et paiement</p>
          <br />
          Les prix des Produits sont indiqués sur le Site en euros et
          s'entendent toutes taxes comprises. Nous nous réservons le droit de
          modifier les prix à tout moment. Toutefois, les Produits seront
          facturés au prix en vigueur au moment de la commande.
          <br />
          <br />
          <br />
          <p className="font-bold text-lg">Droit de rétractation</p>
          <br />
          ...
          de motifs ni à payer de pénalités. Le Client doit informer le Vendeur
          de sa décision de se rétracter en lui envoyant une déclaration par
          courrier recommandé avec accusé de réception. Les Produits doivent
          être retournés dans leur état d'origine, complets et intacts, dans
          leur emballage d'origine et avec une copie de la facture.
          <br />
          <br />
          <p className="font-bold text-lg">Garanties</p>
          <br />
          Le Vendeur garantit que les Produits sont conformes à la description
          faite sur le Site et qu'ils ne présentent pas de vices cachés. La
          garantie ne couvre pas les dommages causés par une utilisation
          inappropriée des Produits ou par une mauvaise manipulation. Le Client
          doit informer le Vendeur de tout défaut de conformité ou de vices
          cachés dans un délai de 2 ans à compter de la livraison des Produits.
          <br />
          <br />
          <p className="font-bold text-lg">Propriété intellectuelle</p>
          <br />
          Le contenu du Site, y compris les textes, les images, les marques
        </div>
      </div>
      <Footer />
    </>
